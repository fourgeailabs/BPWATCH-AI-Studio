...
object WatchSettings {
    ...
    fun setWrist(context: Context, wrist: String) {
        prefs(context).edit().putString(KEY_WRIST, wrist).apply()
    }

    fun getMeasurementLocation(context: Context): Int {
        return if (getWrist(context) == WRIST_RIGHT) {
            Link.MeasurementLocation.RIGHT_WRIST
        } else {
            Link.MeasurementLocation.LEFT_WRIST
        }
    }
    ...
    fun getMonitorConfig(context: Context): MonitorConfig {
        ...
        return MonitorConfig(
            ...
            wrist = p.getString(KEY_WRIST, WRIST_LEFT) ?: WRIST_LEFT,
        )
    }
    ...
    fun saveMonitorConfig(context: Context, config: MonitorConfig) {
        prefs(context).edit()
            ...
            .putString(KEY_WRIST, config.wrist)
            .apply()
    }
    ...
    fun parseMonitorConfig(map: DataMap): MonitorConfig {
        ...
        return MonitorConfig(
            ...
            wrist = if (map.containsKey(Link.KEY_WRIST)) map.getString(Link.KEY_WRIST) ?: WRIST_LEFT else WRIST_LEFT,
        )
    }
...
data class MonitorConfig(
    ...
    val sysLow: Int = 90,
    val diaLow: Int = 60,
    val wrist: String = WatchSettings.WRIST_LEFT,
)
