...
class HealthConnectManager(private val context: Context) {
    ...
    /** Publishes an estimated BP reading with detected posture and wrist location so Health Connect apps (e.g. Samsung Health) record accurate clinical context. */
    suspend fun writeBloodPressure(
        sys: Int,
        dia: Int,
        time: Instant,
        bodyPosition: Int = BloodPressureRecord.BODY_POSITION_SITTING_DOWN,
        measurementLocation: Int = BloodPressureRecord.MEASUREMENT_LOCATION_LEFT_WRIST,
    ) {
