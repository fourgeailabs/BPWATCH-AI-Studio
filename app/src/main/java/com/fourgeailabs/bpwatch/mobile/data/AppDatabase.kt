...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_6_7 = object : Migration(6, 7) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE readings ADD COLUMN bodyPosition INTEGER")
                db.execSQL("ALTER TABLE readings ADD COLUMN measurementLocation INTEGER")
                db.execSQL("ALTER TABLE readings ADD COLUMN activity TEXT")
            }
        }
